...
public class JwtTokenProvider {
    ...
    // TODO
    // Overload for cases where User object might not be immediately available, (OAUTH)
    // but this is less ideal as we need User to save UserActiveToken.
    // Prefer the version that takes a User object.
    public String generateToken(String subjectUsername, String name, Collection<? extends GrantedAuthority> authorities) {
        // This version cannot save to UserActiveToken unless you fetch the User here.
        // It's better to ensure the User object is passed to the primary generateToken method.
        // For now, let's assume the caller will handle User fetching if using this.
        // Or, this method could be deprecated/removed if User object is always available.
