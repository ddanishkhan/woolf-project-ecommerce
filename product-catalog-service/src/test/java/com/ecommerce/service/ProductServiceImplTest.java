...
class ProductServiceImplTest {
    ...
    void getProductByName_Success() throws ProductNotFoundException {
        ...
        var result = productService.getProductByNameFromDb("Mobile");
    ...
    void getProductByName_NoProduct() {
        ...
        var result = assertThrows(ProductNotFoundException.class, () -> productService.getProductByNameFromDb("Mobile 2"));
